...
window.addEventListener('DOMContentLoaded', (event) => {
    fetch(url).then(res => res.json()).then((data) => {
        img[14].addEventListener('click', (e) =>{
            ...
            content.style.backgroundImage= "url('https://res.cloudinary.com/dhetxk68c/image/upload/v1673897980/ProduseI/Untitled_design_19_jtghzb.png')" 
        ...
        img[15].addEventListener('click', (e) =>{
            ...
            content.style.backgroundImage= "url('https://res.cloudinary.com/dhetxk68c/image/upload/v1673899810/ProduseI/Untitled_design_24_xltgol.png')" 
            content.style.backgroundSize= "cover";
            content.classList.remove('hide')
            anim.classList.add('hide')
        })
        img[5].addEventListener('click', (e) =>{
            ...
            content.style.backgroundImage= "url('https://res.cloudinary.com/dhetxk68c/image/upload/v1673900511/ProduseI/Arabica_2_tceimq.png')" 
            content.style.backgroundSize= "cover";
            content.classList.remove('hide')
            anim.classList.add('hide')
        })
        img[4].addEventListener('click', (e) =>{
            ...
            content.style.backgroundImage= "url('https://res.cloudinary.com/dhetxk68c/image/upload/v1673900670/ProduseI/Arabica_3_wdgytd.png')" 
            content.style.backgroundSize= "cover";
            content.classList.remove('hide')
            anim.classList.add('hide')
        })
        img[6].addEventListener('click', (e) =>{
            ...
            content.style.backgroundImage= "url('https://res.cloudinary.com/dhetxk68c/image/upload/v1673900792/ProduseI/Arabica_4_utt8zx.png')" 
            content.style.backgroundSize= "cover";
            content.classList.remove('hide')
            anim.classList.add('hide')
        })
        img[16].addEventListener('click', (e) =>{
            ...
            content.style.backgroundImage= "url('https://res.cloudinary.com/dhetxk68c/image/upload/v1673901588/ProduseI/Arabica_5_vumtvo.png')" 
            content.style.backgroundSize= "cover";
            content.classList.remove('hide')
            anim.classList.add('hide')
        })
        img[7].addEventListener('click', (e) =>{
            ...
            content.style.backgroundImage= "url('https://res.cloudinary.com/dhetxk68c/image/upload/v1673902118/ProduseI/Arabica_7_awhzkg.png')" 
            content.style.backgroundSize= "cover";
            content.classList.remove('hide')
            anim.classList.add('hide')
        })
        img[8].addEventListener('click', (e) =>{
            ...
            content.style.backgroundImage= "url('https://res.cloudinary.com/dhetxk68c/image/upload/v1673942200/ProduseI/Co2_rpsyyr.png')" 
            content.style.backgroundSize= "cover";
            content.classList.remove('hide')
            anim.classList.add('hide')
        })
        img[17].addEventListener('click', (e) =>{
            ...
            content.style.backgroundImage= "url('https://res.cloudinary.com/dhetxk68c/image/upload/v1673943116/ProduseI/Co2_3_pgyg5m.png')" 
            content.style.backgroundSize= "cover";
            content.classList.remove('hide')
            anim.classList.add('hide')
        })
        img[18].addEventListener('click', (e) =>{
            ...
            content.style.backgroundImage= "url('https://res.cloudinary.com/dhetxk68c/image/upload/v1673954773/ProduseI/W_H_I_T_E_4_ulji50.png')" 
            content.style.backgroundSize= "cover";
            content.classList.remove('hide')
            anim.classList.add('hide')
        })
        img[3].addEventListener('click', (e) =>{
            ...
            content.style.backgroundImage= "url('https://res.cloudinary.com/dhetxk68c/image/upload/v1673955280/ProduseI/W_H_I_T_E_6_jquqat.png')" 
            content.style.backgroundSize= "cover";
            content.classList.remove('hide')
            anim.classList.add('hide')
        })
        img[19].addEventListener('click', (e) =>{
            ...
            content.style.backgroundImage= "url('https://res.cloudinary.com/dhetxk68c/image/upload/v1673957284/ProduseI/W_H_I_T_E_16_dsg3a0.png')" 
            content.style.backgroundSize= "cover";
            content.classList.remove('hide')
            anim.classList.add('hide')
        })
        img[13].addEventListener('click', (e) =>{
            ...
            content.style.backgroundImage= "url('https://res.cloudinary.com/dhetxk68c/image/upload/v1673956053/ProduseI/W_H_I_T_E_9_fy8cft.png')" 
            content.style.backgroundSize= "cover";
            content.classList.remove('hide')
            anim.classList.add('hide')
        })
        img[2].addEventListener('click', (e) =>{
            ...
            content.style.backgroundImage= "url('https://res.cloudinary.com/dhetxk68c/image/upload/v1673957840/ProduseI/W_H_I_T_E_20_msdlf9.png')" 
            content.style.backgroundSize= "cover";
            content.classList.remove('hide')
            anim.classList.add('hide')
        })
        img[11].addEventListener('click', (e) =>{
            ...
            content.style.backgroundImage= "url('https://res.cloudinary.com/dhetxk68c/image/upload/v1673958301/ProduseI/W_H_I_T_E_23_t6vtcr.png')" 
            content.style.backgroundSize= "cover";
            content.classList.remove('hide')
            anim.classList.add('hide')
        })
        img[1].addEventListener('click', (e) =>{
            ...
            content.style.backgroundImage= "url('https://res.cloudinary.com/dhetxk68c/image/upload/v1673959318/ProduseI/W_H_I_T_E_28_fxmous.png')" 
            content.style.backgroundSize= "cover";
            content.classList.remove('hide')
            anim.classList.add('hide')
        })
        img[0].addEventListener('click', (e) =>{
            ...
            content.style.backgroundImage= "url('https://res.cloudinary.com/dhetxk68c/image/upload/v1673959752/ProduseI/W_H_I_T_E_31_tujqa0.png')" 
            content.style.backgroundSize= "cover";
            content.classList.remove('hide')
            anim.classList.add('hide')
        })
        img[9].addEventListener('click', (e) =>{
            ...
            content.style.backgroundImage= "url('https://res.cloudinary.com/dhetxk68c/image/upload/v1673960997/ProduseI/W_H_I_T_E_37_r6wtyi.png')" 
            content.style.backgroundSize= "cover";
            content.classList.remove('hide')
            anim.classList.add('hide')
        })
        img[10].addEventListener('click', (e) =>{
            ...
            content.style.backgroundImage= "url('https://res.cloudinary.com/dhetxk68c/image/upload/v1673961212/ProduseI/W_H_I_T_E_39_kphk3i.png')" 
            content.style.backgroundSize= "cover";
            content.classList.remove('hide')
            anim.classList.add('hide')
        })
        img[12].addEventListener('click', (e) =>{
            ...
            content.style.backgroundImage= "url('https://res.cloudinary.com/dhetxk68c/image/upload/v1673961425/ProduseI/W_H_I_T_E_41_wmcc9r.png')" 
            content.style.backgroundSize= "cover";
            content.classList.remove('hide')
            anim.classList.add('hide')
        })
